...
const PLReports = () => {
  ...
  const handleExportExcel = async () => {
    try {
      ...
      link.href = url;
      link.setAttribute('download', 'all-reports.xlsx');
      ...
      <Row>
        <Col>
          <Card>
            <Card.Header>
              <h5 className="mb-0">
                Program Reports ({filteredReports.length})
              </h5>
            </Card.Header>
            <Card.Body>
                  ...
                  <tbody>
                    {filteredReports.map(report => (
                      <tr key={report.id}>
                        ...
                        <td>
                          <Badge bg="info">
                            {streams.find(s => s.id === report.stream_id)?.stream_name || 'N/A'}
                          </Badge>
                        </td>
